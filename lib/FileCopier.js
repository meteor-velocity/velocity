 ...
 *                                        Default: true
 * @param {function} [options.convertTestPathToMirrorPath] A function that converts
...
_.extend(Velocity.FileCopier.prototype, {
  ...
  _convertTestPathToMirrorPath: function _convertTestPathToMirrorPath(filePath) {
  ...
  _defaultConvertTestPathToMirrorPath: function _defaultConvertTestPathToMirrorPath(filePath) {
